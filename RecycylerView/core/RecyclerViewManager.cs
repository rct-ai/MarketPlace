...
{   
    ...
    public class RecyclerViewManager
    {
        ...
        private BaseRecyclerView _baseRecyclerView;
        ...
        // use goes to when Using this variable, update value
        private bool _isGrid => _baseRecyclerView.IsGrid;
        private RectTransform _cellPrefab =>_baseRecyclerView.CellPrefab;
        private bool _isVertical => _baseRecyclerView.vertical;
        
        private RectTransform _viewport => _baseRecyclerView.viewport;
        
        private RectTransform _content => _baseRecyclerView.content;
        
        private IDataProvider _dataProvider => _baseRecyclerView.DataProvider;
        
        
        

        // this method will do some Measure to calculate
        public void OnMeasure(BaseRecyclerView baseRecyclerView)
        {
            this._baseRecyclerView = baseRecyclerView;
            
              
            _numOfRowOrCol = _isGrid ? baseRecyclerView.Segment : 1;
            
            // calculate cell practical size
            _cellWidth = _cellPrefab.sizeDelta.x + baseRecyclerView.Margin.x;
            _cellHeight = _cellPrefab.sizeDelta.y + baseRecyclerView.Margin.y;
        ...
        public void DoStart() {
           ...
           SetTopLeftAnchor(_content);
            ...
            sizeDelta += _baseRecyclerView.Padding;
            ...
            _asyTask = _baseRecyclerView.StartCoroutine(UpdateTasks());
        ...
        private void ClearData()
        {
            DestroyCells();
            if (_asyTask != null) {
                _baseRecyclerView.StopCoroutine(_asyTask);
                _asyTask = null;
            }
        ...
        private Vector2 GetAnchorPos(int index) {
            ...
            return new Vector2(col * _cellWidth, -row * _cellHeight) +
                   new Vector2(_baseRecyclerView.Padding.x, -_baseRecyclerView.Padding.y);
        }
        ...
        private void OnReMeasure() {
            ...
            // onReMeasure
            _cellWidth = _cellPrefab.sizeDelta.x + _baseRecyclerView.Margin.x;
            _cellHeight = _cellPrefab.sizeDelta.y + _baseRecyclerView.Margin.y;
